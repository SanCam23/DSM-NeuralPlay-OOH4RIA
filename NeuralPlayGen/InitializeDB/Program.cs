...
static void Main (string[] args)
{
        ...
        System.Console.WriteLine ("A new database called: NeuralPlayGenNHibernate will be created (the previous information will be deleted).");
        System.Console.WriteLine ("-----------------------------------------------------------------------------");
        ...
        try
        {
                CreateDB.Create ("NeuralPlayGenNHibernate", "nhibernateUser", "nhibernatePass");
                var cfg = new Configuration ();
                cfg.Configure ();
                cfg.AddAssembly (typeof(ParticipacionTorneoNH).Assembly);
