...
public System.Collections.Generic.IList<ComentarioEN> ReadAllDefault (int first, int size)
{
        ...
        try
        {
                ...
                if (ex is NeuralPlayGen.ApplicationCore.Exceptions.ModelException)
                        throw;
                else throw new NeuralPlayGen.ApplicationCore.Exceptions.DataLayerException ("Error in ComentarioRepository.", ex);
        }
...
public void ModifyDefault (ComentarioEN comentario)
{
        try
        {
                ...
                comentarioNH.Contenido = comentario.Contenido;


                comentarioNH.FechaCreacion = comentario.FechaCreacion;


                comentarioNH.FechaEdicion = comentario.FechaEdicion;
